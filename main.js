...
mobile: MethodMobile, 
browser: opcion == '1' ? ['NamiBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['NamiBotMD', 'Edge', '2.0.0'] : ['Chrome (Linux)', '', ''],
auth: {
creds: state.creds,
...
const directories = ['./BotSession/', './JadiBot/']
